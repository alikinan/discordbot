...
${prefix}count/يعرض لك عدد الاشخاص الموجودة في السيرفر من دون بوتات
${prefix}invites/ يعرض لك  عدد الانفايت الخاص بك في السيرفر 
${prefix}invinfo <invitelink here> / لمعلومات عن الدعوه
 مثال : invinfo m82n8P
${prefix}invite-codes/يعرض لك روابط الانفايتات الخاصة بك في السيرفر 
${prefix}cal/الة حاسبة
${prefix}trans <language> <any thing>/يترجم لك الذي تريده من اي لغة
${prefix}short/يختصر لك رابط كبير الى رابط صغير
${prefix}tag/يكتب لك الكلمة بشكل جميل وكبير
${prefix}google/للبحث في قوقل عن طريق الديسكورد
${prefix}perms/يعرض لك البرمشن الخاص بك في السيرفر
${prefix}z5rf/يزخرف لك كلمة او جملة
${prefix}rooms/يعرض لك كل الرومات الموجودة في السيرفر مع عددها
${prefix}roles/يعرض لك جميع الرتب الموجودة في السيرفر بشكل جميل
${prefix}emojilist/يعرض لك كل الايموجيات الموجودة في السيرفر
${prefix}say/يكرر الكلام الذي تكتبه
${prefix}image/يعرض لك صورة السيرفر
${prefix}members/يعرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص
${prefix}id/معلومات عنك
${prefix}bans / عدد الاشخاص المبندة 
${prefix}avatar/صورتك او صورة الذي تمنشن له
${prefix}embed/يكرر الذي تقوله بشكل جميل
...
${prefix}rolebc <everyone or @role> / إرسال رساله لرتبة مخصصة
...
${prefix}hchannel / إخفاء الشات
${prefix}schannel / إظهار الشات المخفية
...
${prefix}dr / <لمسح جميع الرتب  يجب أن تكون رتبة البوت أعلى من جميع الرتب
${prefix}ct <name> / إنشاء شات
${prefix}cv <name> / إنشاء روم صوتي
${prefix}temp / لإنشاء روم مؤقت
${prefix}delet <name> / مسح الشات او الروم الصوتي
${prefix}make <number> / ينشأ لك الوان مع عدد الوان الذي تريده
${prefix}color <number> / لإختيار لون
${prefix}deletecolors <number> / لحذف الألوان
**
   `,`
        ***__Music orders__***
**
${prefix}play / لتشغيل أغنية برأبط أو باسم
${prefix}skip / لتخطي الأغنية الحالية
${prefix}pause / إيقاف الأغنية مؤقتا
${prefix}resume / لإستمرار الإغنية بعد إيقافها مؤقتا
...
${prefix}speed / أسرع كتابة
${prefix}quas / أسئلة عامة
${prefix}نكت / نكت 
${prefix}لعبة فكك / فكك
...
${prefix}voiceonline / لتفعيل روم صوتي للاونلاين
**
   مصممين البوت:
🅰🅱N😈| AliSTOPツ#1828
reham princes#0001
